...
INSERT INTO Metodo(Metodo,ses_id) VALUES ('Depósito',1);
...
DELIMITER ;;
CREATE PROCEDURE update_PagosMonto(IN monto int(10), IN metodoID int(10), IN idpm int(10), ses int(11))
BEGIN
	UPDATE Pagos SET Monto = monto, MetodoID = metodoID, ses_id = ses WHERE ID = idpm;
END;;
DELIMITER ;
...
BEGIN
    ...
    SELECT IFNULL(SUM(Monto),0) INTO @pagos_gastos
